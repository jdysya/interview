...
const sections = [
  { text: "🧭 学习与自测", prefix: "/guide/", children: ["", "question-bank", "answer-method", "visual-map", "sources", "updates"] },
  ...
  { text: "🔬 项目与实验", prefix: "/projects/", children: ["", "database-agent", "inventory-reservation", "approval-consistency", "experiments"] },
...
export default defineUserConfig({
  ...
  description: "AI 应用、Agent、Java 后端：机制详解、可视化、算法实作、项目深挖与自测。",
  bundler: viteBundler(),
  theme: hopeTheme({
